# This class builds a layer containing neurons.  It can connect layers together through rann connections.
module Rann
  class Layer
    ...
    def build_neurons
      ...
      when Array
        fail StandardError.new('Layer neurons are not all of Neuron class') if neurons_or_count.collect { |n| !n.is_a?(Rann) }.any?
